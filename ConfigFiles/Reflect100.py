...
## File paths ##
saveFolder = 'Reflect100Data'     # Folder where to save the data
...
gapMaterial = 'al'     # Material of the gaps
...
overwriteProperties = {     # See README.md for list of properties and available modifications
    ...
    'si' : {'reflectivity' : {0 : 1.0, 1 : 1.0},
            'diffusefraction' : {0 : 0.05, 1 : 0.05}},
    'al' : {'reflectivity' : {0 : 1.0, 1 : 1.0},
            'diffusefraction' : {0 : 0.05, 1 : 0.05}}
}
