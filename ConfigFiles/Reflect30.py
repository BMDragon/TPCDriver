# Created by script on 7/26/2022
import Driver
import math

## File paths ##
saveFolder = 'Reflect30Data'     # Folder where to save the data
...
sipmSize = 4.5/1000     # Size of the SiPMs themselves
sipmGapSize = 0.5/1000     # Distance between SiPMs in the array
...
tracks = {     # Start and end points for tracks in the TPC in (x, y, z)
    'track' : [(0., 0., 0.5*height, 0.), (0., 0.01, 0.5*height)]     # Units of meters and seconds
}
angleMode = 'controlled'     # Mode of specifying initial angle
theta = 3.14*40/180     # Initial photon theta
...
overwriteProperties = {     # See README.md for list of properties and available modifications
    'vikuitilar' : {'reflectivity' : {0 : 0.0, 1 : 0.0}},
    'si' : {'reflectivity' : {0 : 0.3, 1 : 0.3}},
    'black' : {'reflectivity' : {0 : 0.3, 1 : 0.3},
               'diffusefraction' : {0 : 0.0}}
}
